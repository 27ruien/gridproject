...
const icons = {
  ...
  security: ["M12 3 20 7v5c0 5-3.4 8.1-8 9-4.6-.9-8-4-8-9V7l8-4Z", "M9 12l2 2 4-4"],
  ...
  eyeOff: ["M3 3l18 18", "M10.6 6.2A10 10 0 0 1 12 6c6 0 9.5 6 9.5 6a12 12 0 0 1-3 3.7", "M6.2 6.2A12 12 0 0 0 2.5 12s3.5 6 9.5 6c1 0 2-.2 2.8-.5"],
};
