...
export const PROJECT_TEMPLATES = [
  {
    ...
    positioning: "围绕 Backlog、Sprint 和看板推动高频研发迭代。",
    defaultView: "概览",
    views: ["概览", "Backlog", "Sprint", "看板", "甘特图", "版本", "复盘"],
    ...
    emptyState: {
      title: "先建立需求池",
      description: "补充 Epic、需求和缺陷，再选择 P0/P1 进入 Sprint。",
      action: "新建需求",
    },
    milestones: [
      { name: "需求梳理", window: "第 1 周", focus: "收敛优先级和验收标准" },
      { name: "Sprint 交付", window: "第 2-3 周", focus: "完成核心需求与缺陷闭环" },
