...
export const projectService = {
  ...
  createProject(input) {
    ...
    return {
      ...
      executionTeams: Array.isArray(input.executionTeams) ? [...new Set(input.executionTeams)] : [],
      startDate: input.startDate || "",
      dueDate: input.dueDate || "",
      testDate: input.testDate || "",
      acceptanceDate: input.acceptanceDate || "",
      releaseDate: input.releaseDate || "",
      milestones: createProjectMilestones(template, input.startDate || ""),
      health: 90,
      description: input.description?.trim() || "暂无项目概述。",
      createdAt: now,
      updatedAt: now,
    };
  },
  updateProject(project, patch) {
    ...
    return {
      ...project,
      ...patch,
      executionTeams: Array.isArray(patch.executionTeams) ? [...new Set(patch.executionTeams)] : project.executionTeams || [],
