...
const issues: Issue[] = [
  normalizeIssue({ id: "i1", code: "TASK-118", projectId: "crm", type: "需求", title: "批量分配线索", status: "未开始", owner: "林夏", ownerId: "user-linxia", creator: "林夏", creatorId: "user-linxia", priority: "P0", startDate: "2026-05-12", dueDate: "2026-05-18", estimatedHours: 32, actualHours: 8, next: "补齐验收标准并确认是否进入 v1.6.0", description: "支持销售主管按区域、客户等级、线索来源批量分配线索。" }),
  normalizeIssue({ id: "i2", code: "TASK-124", projectId: "crm", type: "任务", title: "迭代燃尽图数据接口", status: "进行中", owner: "周程", ownerId: "user-zhoucheng", creator: "林夏", creatorId: "user-linxia", priority: "P1", startDate: "2026-05-10", dueDate: "2026-05-22", estimatedHours: 48, actualHours: 26, next: "完成剩余工作量统计接口", description: "提供迭代维度的燃尽图数据。" }),
  normalizeIssue({ id: "i3", code: "TASK-130", projectId: "crm", type: "缺陷", title: "客户归属变更后看板未刷新", status: "未开始", owner: "韩越", ownerId: "user-hanyue", creator: "周程", creatorId: "user-zhoucheng", priority: "P1", startDate: "2026-05-13", dueDate: "2026-05-15", estimatedHours: 12, actualHours: 2, next: "确认缓存刷新策略", description: "客户归属字段被批量更新后，销售工作台仍展示旧数据。" }),
  normalizeIssue({ id: "i4", code: "TASK-203", projectId: "mall", type: "交付物", title: "客户需求确认书", status: "待验收", owner: "韩越", ownerId: "user-hanyue", creator: "韩越", creatorId: "user-hanyue", priority: "P0", startDate: "2026-05-11", dueDate: "2026-05-16", estimatedHours: 18, actualHours: 7, next: "补齐客户签字版和范围边界", description: "瀑布项目进入设计前必须冻结需求范围和验收口径。" }),
  normalizeIssue({ id: "i5", code: "TASK-219", projectId: "mall", type: "风险", title: "设计确认延期", status: "进行中", owner: "陈澈", ownerId: "user-chenche", creator: "韩越", creatorId: "user-hanyue", priority: "P1", startDate: "2026-05-09", dueDate: "2026-05-14", estimatedHours: 10, actualHours: 4, next: "确认客户反馈截止时间", description: "客户设计确认延期 2 天，影响后续开发实施窗口。" }),
];
